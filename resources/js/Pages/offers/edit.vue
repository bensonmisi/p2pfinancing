...
export default {
    props:['successMessage','errorMessage','balance','loan','loanable','offer'],
    components:{
        Layout
    },data(){
        return{
            ...
            amountRules:[
                ...
                v => (v && v <= this.loan.amount) || 'You cannot fund more than the required amount '+this.loan.amount
            ],
            rate:this.offer.percentage,
        ...
        submit(){
            if(this.$refs.form.validate()){
                this.loading= true
                var data = {loan:this.loan.id,amount:this.amount,percentage:this.rate}
